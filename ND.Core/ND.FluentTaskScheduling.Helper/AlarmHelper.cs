   ...
   public class AlarmHelper
    {
       ...
       public static void Alarm(int isEnableAlarm, AlarmType alarmType, string alarmperson,string title,string content)
       {
       ...
       /// <param name="title">预警标题</param>
       /// <param name="content">预警内容</param>
       public static void AlarmAsync(int isEnableAlarm, AlarmType alarmType, string alarmperson, string title, string content)
       {
           Task.Factory.StartNew(() =>
           {
               try
               {
                   Alarm(isEnableAlarm, alarmType, alarmperson, title, content);
               }
               catch(Exception ex)
               {
